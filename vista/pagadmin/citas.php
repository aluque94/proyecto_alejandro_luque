            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">            
                                <a href="nuevacita.php" class="btn btn-success">Nuevo</a>    
                            </div>    
                        </div>    
                    </div> <br>
                    ...
                    <?php
                        ...
                        echo "<div class='text-center'>
                                <table class='table table-striped table-bordered table-condensed' style='width=100%'><tr>
                        ...
                        for ($i = 1; $i <= $diasTotales; $i++) {
                            ...
                            $listadoCitas = getListaCitasCalendar($diaCita);
                            ...
                            while ($fila = mysqli_fetch_assoc($listadoCitas)) {
                                ...
                                $citaGuardada .= "<br><a href='nuevacita.php?editar=" . $id ."'>" . $fila['Nombre'] . " " . $fila['Apellidos'] . "</a>";
