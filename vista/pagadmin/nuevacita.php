            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="citas.php">Citas</a>
                    </div>
                </div>
            </li>
                ...
                <div class="container-fluid">
                    ...
                    <form method="post" action="nuevacita.php">
                        ...
                        <?php
                            ...
                            if (isset($_GET['editar'])) {
                                ...
                                /* Con el ID obtenemos de nuevo todos los datos de la ciudad. */
                                $datoscita = mysqli_fetch_assoc(getCita($id));

                                echo "<h1>Modificar cita</h1>" . $datoscita['Nombre'] . " " . $datoscita['Apellidos'];
                            } else {
                                /* Si vengo de otro lado. */
                                echo "<h1>Nueva cita</h1>";
                                $datoscita = ["Nombre" => "",
                                        "Apellidos" => "",
                                        "Fecha" => "",
                                        "Hora" => "",
                        ...
                        <div>Fecha: </div>
                        <!-- Incluyo los valores por defecto si estoy editando. -->
                        ...
                        <div class="botones">
                            <!-- Paso el ID para saber que lo que estoy haciendo es editar un elemento. -->
                    ...
                    <?php
                        ...
                        if (isset($_POST['Pedir'])) {
                            ...
                            echo "<br><a href='citas.php'>Volver a la lista de citas</a>";
                        }
